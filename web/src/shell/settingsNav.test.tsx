...
describe("settingsNavGroups", () => {
  ...
  it("includes the Admin group (Members / Policies / Sharing / Deployment) for any admin", () => {
  ...
  it("drops Members and Sharing from the Admin group in single-user mode", () => {
    ...
    expect(singleUserAdmin?.items.map((i) => i.id)).toEqual(["policies", "deployment"]);
  });
