...
async def test_delete_conversation_cascades_fk_referenced_tables(
    ...
    with conversation_store._session() as session:  # type: ignore[attr-defined]
        ...
        session.execute(
            text(
                "INSERT INTO routing_proposals (workspace_id, id, conversation_id, elicitation_id, "  # noqa: E501
                "user_message_sha256, user_message_excerpt, user_message_chars, content_types_json, "  # noqa: E501
                "original_route_id, requires_explicit_approval, proposal_payload_excerpt, "
                "proposal_payload_sha256, created_at) "
                "VALUES (:ws, 'rp_test1', :cid, 'elic_rp1', 'sha1', 'excerpt', 5, '[]', 'auto/cheap', 0, '{}', 'psha1', 0)"  # noqa: E501
            ),
            {"ws": ws, "cid": conv.id},
        )
        session.execute(
            text(
                ...
                "VALUES (:ws, 'rd_test1', 'rp_test1', 'declined', 'rsha1', 'auto/cheap', '{}', 'dpsha1', 0)"  # noqa: E501
            ),
            {"ws": ws},
        )
