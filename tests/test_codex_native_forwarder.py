...
from omnigent.harnesses.codex_native.app_server import CodexTraceLaunchProvenance
...
def test_thread_started_is_ephemeral_true_for_ephemeral_system_thread() -> None:
    ...
    assert fwd._thread_started_is_auxiliary(event) is True
...
def test_thread_started_is_ephemeral_false_for_persistent_clear_thread() -> None:
    ...
    assert fwd._thread_started_is_auxiliary(event) is False
