...
def _patch_session_as_claude_native(
    ...
    :param permission_mode: Initial ``omnigent.harnesses.claude_native.main.permission_mode``
    ...
    def _handle(route: Route) -> None:
        ...
        if cur_permission_mode[0] is not None:
            extra_labels["omnigent.harnesses.claude_native.main.permission_mode"] = (
                cur_permission_mode[0]
            )
        payload["labels"] = {
            **payload.get("labels", {}),
