    ...
    *,
    ...
    def _handle(route: Route) -> None:
        ...
        if request.method == "GET":
            ...
            prior_mode = prior_labels.get(
                "omnigent.harnesses.codex_native.main.collaboration_mode"
            )
            if prior_mode is not None:
                payload["labels"] = {
                    **payload.get("labels", {}),
                    "omnigent.harnesses.codex_native.main.collaboration_mode": prior_mode,
                }
            ...
            if "collaboration_mode" in request_body:
                ...
                labels["omnigent.harnesses.codex_native.main.collaboration_mode"] = request_body[
                    "collaboration_mode"
                ]
...
def test_codex_native_plan_mode_toggle_uses_codex_session_patch(
    ...
    badge from Codex's raw ``omnigent.harnesses.codex_native.main.collaboration_mode`` label
