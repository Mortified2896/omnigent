...
_APPROVAL_MODE_LABEL_KEY = "omnigent.harnesses.codex_native.main.approval_mode"
...
def _patch_session_as_codex_native(
    ...
    *,
    ...
    :param approval_mode: Initial ``omnigent.harnesses.codex_native.main.approval_mode``
...
def test_codex_native_approval_mode_starts_from_label(
    ...
    ``omnigent.harnesses.codex_native.main.approval_mode``, and the picker reflects it on
