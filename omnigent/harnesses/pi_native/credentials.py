...
def _enumerate_inline_family_models(
    ...
    try:
        from omnigent.models.model_catalog import ResolvedModelProvider, is_direct_openai_provider
        from omnigent.models.model_catalog import (
            _fetch_openai_compatible_listing as _fetch_listing,
        )
...
def _inline_family_pi_provider(
    ...
    for family_name in _inline_family_order(model):
        ...
        return PiProviderConfig(
            ...
            extra_models=[model_entry, *[m for m in extra_models if m["id"] != model_entry["id"]]],
        )
    return None
...
def pi_native_provider_launch(
    ...
    *,
    ...
    if codex_model is not None:
        return PiNativeLaunch(*pi_native_codex_launch(agent_dir, codex_model))
