...
Migration `f8a9b0c1d2e3` follows the inspected head `f7a8b9c0d1e2`. Downgrading drops the feedback table and its data. Existing transcript tables are unchanged. Split conversation databases acquire the table through the existing ConversationBase schema initialization.
