# Canary D.1 report — D8-20260802T100513Z

| Rebuild SHA | Run ID | Phase | Port | Prod port | Data dir | Auth header |
| --- | --- | --- | --- | --- | --- | --- |
| `113340be` | `D8-20260802T100513Z` | D.1 (initial) | `17670` | `4097` | `/tmp/canary-data` | `X-Forwarded-Email` |
...
```
Preparing worktree (new branch 'polly/canary-4-pi-D8-20260802T100513Z')
...
```
FAIL no git.commit.outcome event in session JSON at /tmp/canary-fixtures/D8-20260802T100513Z/pi/worktree/.session.json
```
...
```
Preparing worktree (new branch 'polly/canary-7-opencode-D8-20260802T100513Z')
...
```
Preparing worktree (new branch 'polly/canary-11-verity-D8-20260802T100513Z')
...
```
Preparing worktree (new branch 'polly/canary-12-pi-a-D8-20260802T100513Z')
Preparing worktree (new branch 'polly/canary-12-pi-b-D8-20260802T100513Z')
...
Full per-check stdout+stderr captured under `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D8-20260802T100513Z/log/*.log`.
TSV results in `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D8-20260802T100513Z/results.tsv`.
Env snapshot in `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D8-20260802T100513Z/canary.env`.
