# Canary D.1 report — D3-20260802T095716Z

| Rebuild SHA | Run ID | Phase | Port | Prod port | Data dir | Auth header |
| --- | --- | --- | --- | --- | --- | --- |
| `113340be` | `D3-20260802T095716Z` | D.1 (initial) | `17670` | `4097` | `/tmp/canary-data` | `X-Forwarded-Email` |
...
```
Preparing worktree (new branch 'polly/canary-4-pi-D3-20260802T095716Z')
FAIL POST /v1/sessions failed; body: {
  "agent_id": "a1b7caa17404f6716180ba69aa37c592",
  "purpose": "implement",
  "workspace": "/tmp/canary-fixtures/D3-20260802T095716Z/pi/worktree",
  ...
  "title": "canary-pi-native-ui-polly/canary-4-pi-D3-20260802T095716Z"
}
...
```
Preparing worktree (new branch 'polly/canary-7-opencode-D3-20260802T095716Z')
FAIL POST /v1/sessions failed; body: {
  "agent_id": "cf65137fc096a61a6434956c92093549",
  "purpose": "implement",
  "workspace": "/tmp/canary-fixtures/D3-20260802T095716Z/opencode/worktree",
  "prompt": "rename the function foo to bar. Run pytest, lint, and typecheck on what you changed. Push your branch when green. Open a PR with gh pr create if a remote is configured.",
  "title": "canary-opencode-native-ui-polly/canary-7-opencode-D3-20260802T095716Z"
}
FAIL function bar not present in diff
```
...
```
Preparing worktree (new branch 'polly/canary-11-verity-D3-20260802T095716Z')
...
```
Preparing worktree (new branch 'polly/canary-12-pi-a-D3-20260802T095716Z')
Preparing worktree (new branch 'polly/canary-12-pi-b-D3-20260802T095716Z')
...
FAIL POST /v1/sessions failed; body: {
  "agent_id": "a1b7caa17404f6716180ba69aa37c592",
  "purpose": "implement",
  "workspace": "/tmp/canary-fixtures/D3-20260802T095716Z/parallel/wt-b",
  "prompt": "rename the function foo to bar. Run pytest, lint, and typecheck on what you changed. Push your branch when green. Open a PR with gh pr create if a remote is configured.",
  "title": "canary-pi-native-ui-polly/canary-12-pi-b-D3-20260802T095716Z"
}
```

## Per-run artifacts

Full per-check stdout+stderr captured under `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D3-20260802T095716Z/log/*.log`.
TSV results in `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D3-20260802T095716Z/results.tsv`.
Env snapshot in `/home/hermes/workspace/repos/omnigent-eval-rebuild-upstream-0.7/docs/rebuild/canary-runs/D3-20260802T095716Z/canary.env`.
